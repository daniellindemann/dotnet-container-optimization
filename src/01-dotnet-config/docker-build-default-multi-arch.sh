...
#       docker buildx build --push --platform linux/amd64,linux/arm64 -t <acrLoginServer>/01-dotnet-config:1.0.0 -f $SCRIPT_DIR/Dockerfile.default-multi-arch $SCRIPT_DIR
